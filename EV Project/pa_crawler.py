...
entries = []
entry = []
urlnumber = 151 # Give the page number to start with

while urlnumber < 256: # Give the page number to end with, please make sure this number < 300
...
df = pd.DataFrame(stringlist, columns = ['Username','Date',"Text"])
#df.to_excel("edmunds_extraction.xlsx",index=False) # Uncomment this if you want to save the output in excel file
#print ("Wrote to edmunds_extraction.xlsx") # Uncomment this if you want to save the output in excel file
